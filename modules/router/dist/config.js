...
const DEFAULT_MODELS = {
    'minimax/minimax-m2.5': {
        ...
        alias: 'minimax',
        pricePer1MInput: 0.75,
        pricePer1MOutput: 2.25,
        maxTokens: 16384,
        priority: 1
    },
    ...
    'google/gemini-2.0-flash-exp': {
        ...
        pricePer1MOutput: 1.50,
        maxTokens: 8192,
        priority: 5
    }
};
function loadConfig() {
    const useDeepSeekForStrict = process.env.OPENCLAW_REASON_STRICT_DEEPSEEK === '1' ||
        process.env.REASON_STRICT_DEEPSEEK === '1';
    ...
    const baseConfig = {
        models,
        defaultModel: useDeepSeekForStrict ? 'deepseek/deepseek-v3.2' : 'stepfun/step-3.5-flash:free',
        fallbacks: [
            'arcee-ai/trinity-large-preview:free',
        ...
        logging: {
            routingLog: process.env.OPENCLAW_ROUTING_LOG === '1' || !!process.env.OPENCLAW_ROUTING_LOG,
            routingLogPath: process.env.OPENCLAW_ROUTING_LOG || undefined,
            debugRoute: process.env.OPENCLAW_DEBUG_ROUTE === '1',
            structured: true
        }
    };
    return baseConfig;
