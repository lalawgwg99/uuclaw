...
> 一個基於 [OpenClaw](https://github.com/nicepkg/openclaw) 的五人特遣隊：由最高統帥透過 Telegram 遙控的本地多代理人協作系統。
...
- **🕵️ 情報搜索 (Intelligence Gathering)**：百曉生透過 VectorEngine API 搜索前沿科技趨勢與即時新聞。
